...
<html>
<head>
<title>   نظام ادارة طلاب مواهب اكاديمي || Home Page</title>
...
<div class="slider">
       <div class="callbacks_container">
        <ul class="rslides" id="slider">
         <li>     
          <h3>  مواهب اكاديمي</h3>      
           <p>    يمكن للطلاب المسجلين تسجيل الدخول هنا</p>             
          <div class="readmore">
          <a href="user/login.php"> تسجيل الدخول<i class="glyphicon glyphicon-menu-right"> </i></a>
          </div>
         </li>
